...
public class ShardConfigParser {
    ...
    private static final String SHARD_CONFIG_DTD = "com/dld/hll/shardbatis/builder/shardbatis-config.dtd";
     ...
     * @throws Exception
     */
    public ShardConfigHolder parse(InputStream input) throws ParserConfigurationException, SAXException, IOException {
